...
class TimerApp:
    def __init__(self, root):
        ...
        self.preset_10_button = tk.Button(self.preset_frame, text="10:00", command=lambda: self.set_preset_timer(10))
        self.preset_10_button.pack(side=tk.LEFT, padx=5)
        self.preset_20_button = tk.Button(self.preset_frame, text="20:00", command=lambda: self.set_preset_timer(20))
        self.preset_20_button.pack(side=tk.LEFT, padx=5)
        self.preset_30_button = tk.Button(self.preset_frame, text="30:00", command=lambda: self.set_preset_timer(30))
        self.preset_30_button.pack(side=tk.LEFT, padx=5)
